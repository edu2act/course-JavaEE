...
document.observe("dom:loaded", function() {
  (function(){
    ...
    function init_notification_menu() {
      ...
      notifications_summary.update('<div class="menu_title clearfix"><span class="title">提醒</span><span class="all"><a href="/notifications">查看所有 »</a></span></div>');
    ...
    function update_unread_count(pe) {
      new Ajax.Request('/notifications/unread_count.json', {
        method: "get",
